...
class ComponentModel { String id; ComponentType type; Offset position; Map<String,dynamic> properties; List<Port> ports;
  ...
  String get label { switch(type) { case ComponentType.resistor: return 'مقاومة'; case ComponentType.voltageSource: return 'مصدر'; case ComponentType.ground: return 'أرضي'; default: return 'عنصر'; } }
}